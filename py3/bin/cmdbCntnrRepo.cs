...
(setq  b:py:cs:csuList
  (list
   ...
   "bisos.cmdb.cmdbCntnrRepo"
 ))
#+END_SRC
#+RESULTS:
| bisos.b.cs.ro | bisos.csPlayer.bleep | bisos.bpo.bpo | bisos.b.fpCls | bisos.b.clsMethod_csu | bisos.common.csCmndsRun | bisos.cmdb.cmdbCntnrRepo |
#+end_org """
...
from bisos.cmdb import cmdbCntnrRepo


csuList = [ 'bisos.b.cs.ro', 'bisos.csPlayer.bleep', 'bisos.bpo.bpo', 'bisos.b.fpCls', 'bisos.b.clsMethod_csu', 'bisos.common.csCmndsRun', 'bisos.cmdb.cmdbCntnrRepo', ]
...
####+BEGIN: b:py3:cs:main/exposedSymbols :classes ("cmdbCntnrRepo.CmdbCntnr_FPs")
""" #+begin_org
...
CmdbCntnr_FPs = cmdbCntnrRepo.CmdbCntnr_FPs # exec/eval-ed as __main__.ClassName
...
"""
        ...
        cmdbCntnrRepo.examples_csu(sectionTitle="default")
